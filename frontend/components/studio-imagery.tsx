...
const FULL_TEXT = "AI receptionist for service businesses"
...
const SCENARIOS = [
  {
    text: "AI calls for service businesses",
    images: [
      { src: "https://images.unsplash.com/photo-1600948836101-f9ffda59d250?w=800&q=80", alt: "Luxury nail salon", delay: 0 },
  ...
  {
    text: "Voice AI that books for you 24/7",
    images: [
  ...
  {
    text: "Never miss another booking call",
    images: [
  ...
  {
    text: "CRM sync, calendar, SMS—automated",
    images: [
    ...
    <div className="w-full">
      ...
      >
        <h2 className="text-balance text-2xl sm:text-3xl font-semibold tracking-tight text-foreground md:text-4xl lg:text-5xl">
          Grow Your Business Without <br className="hidden sm:block" />
