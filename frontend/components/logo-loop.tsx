...
export type LogoItem =
    ...
    | {
        ...
        width?: number;
        height?: number;
        // Optional: specific image for dark mode
        srcDark?: string;
        // Optional: specific classes for this item (e.g. dark:invert)
        className?: string;
    };
        ...
        const renderLogoItem = useCallback(
            (item: LogoItem, key: React.Key) => {
                ...
                if (isNodeItem) {
                    ...
                    const { src, srcDark, className: itemClassName } = item as any;

                    const baseImgClasses = cx(
                    ...
                    if (srcDark) {
                        content = (
                            <>
                                <img
                                    className={cx(baseImgClasses, 'block dark:hidden')}
                                    src={src}
                                ...
                                />
                                <img
                                    className={cx(baseImgClasses, 'hidden dark:block')}
                                    src={srcDark}
                                    // Assuming same dimensions/sizes for dark variant
                                    width={(item as any).width}
                                    height={(item as any).height}
                                    alt={(item as any).alt ?? ''}
                                    title={(item as any).title}
                        ...
                        content = (
                            <img
                                className={cx(baseImgClasses, 'block')}
                                src={src}
                                srcSet={(item as any).srcSet}
                                sizes={(item as any).sizes}
                                width={(item as any).width}
