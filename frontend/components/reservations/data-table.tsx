...
import { Search, SlidersHorizontal, Filter, Plus } from "lucide-react"
                        ...
                        <div className="flex items-center gap-2">
                            <DropdownMenu>
                                ...
                                <DropdownMenuContent align="start" className="w-[200px]">
                                    {["pending", "confirmed", "checked_in", "cancelled", "checked_out"].map((status) => (
                                        <DropdownMenuCheckboxItem
                                            key={status}
                        ...
                        {table.getRowModel().rows?.length ? (
                            ...
                            <TableRow>
                                <TableCell colSpan={columns.length} className="h-32 text-center text-slate-500">
                                    {loading ? "Syncing data..." : "No reservations found."}
                                </TableCell>
                            </TableRow>
                        )}
                    </TableBody>
